...
import laundry.model.ModelMenu;
import laundry.event.EventMenuSelected;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listMenu1 = new laundry.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/laundry/icon/logo.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(15, 15, 15)
                .addComponent(listMenu1, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE))
        );
...
public void initMoving(JFrame frame){
    ...
    private laundry.swing.ListMenu<String> listMenu1;
