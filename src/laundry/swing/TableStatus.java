   ...
   private StatusType type; 
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (type == StatusType.PENDING) {
            g = new GradientPaint(0,0,new Color(186, 123, 247),0,getHeight(),new Color(197, 94, 236));
        }else if (type == StatusType.APPROVED) {
              g = new GradientPaint(0,0,new Color(142, 142, 250),0,getHeight(),new Color(123, 123, 245));
        }else{
              g = new GradientPaint(0,0,new Color(241, 206, 62),0,getHeight(),new Color(211, 184, 61));
        }
        g2.setPaint(g);
